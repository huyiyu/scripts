...
![自带过滤器链](img/filterchain.png)

![插入后的过滤器链](img/filterchainproxy.png)
...
#### 数据库表分析
![pbac-engine](img/pbac_engine.png) 
